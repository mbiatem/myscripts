...
then
 ...
 $WGET  --load-cookies="$COOKIE_FILE" "https://updates.oracle.com/Orion/Services/download/p35226999_122140_Generic.zip?aru=25170306&patch_file=p35226999_122140_Generic.zip" -O "$OUTPUT_DIR/p35226999_122140_Generic.zip"   >> "$LOGFILE" 2>&1 
